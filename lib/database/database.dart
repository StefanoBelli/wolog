...
const String ddlStmts =
  ...
  '    ON DELETE CASCADE'
  '    ON UPDATE CASCADE,'
  '  PRIMARY KEY(DateTimestamp, ExerciseName));'
  ''
  ...
  '  WeightKg REAL,'
  '  Description TEXT,'
  '  FOREIGN KEY(SessionDateTimestamp, SessionExerciseName) REFERENCES Session(DateTimestamp, ExerciseName)'
  '    ON DELETE CASCADE'
  '    ON UPDATE CASCADE,'
  '  PRIMARY KEY(SetId, SessionDateTimestamp, SessionExerciseName))'
  ''
  ;
